...
import product2 from "./images/products/men/product2.jpg";
import product3 from "./images/products/men/product3.jpg";
import product4 from "./images/products/men/product4.jpg";
import product5 from "./images/products/women/product1.jpg";
import product6 from "./images/products/women/product2.jpg";
import product7 from "./images/products/women/product3.jpg";
import product8 from "./images/products/women/product4.jpg";
    ...
    <div className="container mx-auto p-5">
      ...
      <div className="my-20">
        ...
        <div className="grid grid-flow-row grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product2} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product3} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
                <a href="#">Nike Shoes</a>
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product4} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
      ...
      <div className="my-20">
        ...
        <div className="grid grid-flow-row grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product5} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product6} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product7} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
          ...
          <div className="shadow-lg rounded-lg">
            <a href="#">
              <img src={product8} className="rounded-tl-lg rounded-tr-lg" />
            </a>
            <div className="p-5">
              <h3>
